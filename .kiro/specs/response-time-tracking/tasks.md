...
- [ ] 1. Add type and create domain module
  - [ ] 1.1 Add `ResponseTimeRecord` interface to `src/types/index.ts`
    - Add the `ResponseTimeRecord` interface with fields: tableNumber, factorA, factorB, responseTimeMs, isCorrect, timestamp
    - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5, 5.6_

  - [ ] 1.2 Create `src/domain/response-times.ts` with all domain functions
...
- [ ] 2. Integrate timer into PracticeScreen
  - [ ] 2.1 Add response time measurement to `src/components/PracticeScreen.tsx`
...
- [ ] 4. Write tests for the domain module
  - [ ]* 4.1 Write property test: creation preserves question data and produces valid fields
